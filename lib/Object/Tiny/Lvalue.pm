...
sub import {
	return unless shift eq 'Object::Tiny::Lvalue';
	my $pkg   = caller;
	my $child = !! @{"${pkg}::ISA"};
	eval join "\n",
		"package $pkg;",
...
Object::Tiny::Lvalue - Class building as simple as it gets (with rw accessors)
...
To use Object::Tiny::Lvalue, just call it with a list of accessors to be
created.

  use Object::Tiny::Lvalue 'foo', 'bar';

=head1 SUPPORT

Bugs should be reported via the CPAN bug tracker at

L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Object-Tiny-Lvalue>
...
Aristotle Pagaltzis E<lt>pagaltzis@gmx.deE<gt> for the Object::Tiny::Lvalue variant.
...
Copyright 2009 Aristotle Pagaltzis.
